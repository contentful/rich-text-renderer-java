...
public class MarksTextTest {
  ...
  public void boldTextTest() {
    ...
    final CharSequence result = processor.process(context, new CDARichText("BoldText", markers));
  ...
  public void underlineTextTest() {
    ...
    final CharSequence result = processor.process(context, new CDARichText("Underlined", markers));
  ...
  public void testItalic() {
    ...
    final CharSequence result = processor.process(context, new CDARichText("Italic", markers));
  ...
  public void codeTextTest() {
    ...
    final CharSequence result = processor.process(context, new CDARichText("final String code;", markers));
  ...
  public void customTextTest() {
    ...
    final CharSequence result = processor.process(context, new CDARichText("🐭", markers));
  ...
  public void allTextTest() {
    ...
    final CharSequence result = processor.process(context, new CDARichText("All in all", markers));
